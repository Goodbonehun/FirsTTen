...
OUTPUTS = {
    32: "firstten-favicon-32-v5.png",
    96: "firstten-app-icon-96-v5.png",
    180: "firstten-apple-touch-icon-v5.png",
    192: "firstten-app-icon-192-v5.png",
    512: "firstten-app-icon-512-v5.png",
}
