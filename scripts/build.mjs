...
const textAssets=${JSON.stringify({"/manifest.webmanifest":manifest,"/sw.js":serviceWorker,"/pwa.js":pwaScript})};
const mime={"manifest.webmanifest":"application/manifest+json; charset=utf-8","sw.js":"text/javascript; charset=utf-8","pwa.js":"text/javascript; charset=utf-8","png":"image/png"};
