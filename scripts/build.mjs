...
const manifest = await readFile(path.join(publicDir, "firstten-v4.webmanifest"), "utf8");
...
const binaryAssets = Object.fromEntries(await Promise.all(
  ["firstten-favicon-32-v4.png", "firstten-app-icon-96-v4.png", "firstten-app-icon-192-v4.png", "firstten-app-icon-512-v4.png", "firstten-apple-touch-icon-v4.png", "og.png"].map(async name => [name, (await readFile(path.join(publicDir, name))).toString("base64")])
));
...
const textAssets=${JSON.stringify({"/firstten-v4.webmanifest":manifest,"/sw.js":serviceWorker,"/pwa.js":pwaScript})};
const mime={"firstten-v4.webmanifest":"application/manifest+json; charset=utf-8","sw.js":"text/javascript; charset=utf-8","pwa.js":"text/javascript; charset=utf-8","png":"image/png"};
